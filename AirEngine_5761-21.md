...
## 产品特点
AirEngine 5761-21是华为发布的标准型Wi-Fi 6（802.11ax）室内AP。适用于中小型企业办公、零售、教育等普通室内覆盖场景。

- 支持2.4GHz（2x2 MIMO）和5GHz（4x4 MIMO）双射频同时提供业务。
- 对于02354VQK，支持1*2.5GE电口+1*GE电口。对于02353VUT，支持2*GE电口。
...
| 802.3af供电说明 | Wi-Fi：2.4GHz(2x2)+5GHz(2x2)，最大合路功率调整为22dBm(2.4GHz)、22dBm(5GHz)。有线网口：2.5GE/POE_IN降为GE使用，GE电口不可用；其他接口：USB不可用； |
| DC供电说明 | 所有功能不受限制。 |
